...
def main():
    ...
    if args.not_train:
        ...
        model = YOLO(
            "CF_Pilar_tracking_Yolov8m_11_cam/Yolov8m_2/weights/best.pt"
        ...
        model.train(
            ...
            project="CF_Pilar_tracking_Yolov8m_11_cam",  # Gestion_fila_Yolov8m_4_cam - Gestion_fila_Yolov8n_4_cam
